function plotType1Correct(targetDiscriminationDataAll)

    % Get the % correct for each intensity
    pCorrect_5percent = permute(targetDiscriminationDataAll(1,1,:), [3,2,1]);
    pCorrect_15percent = permute(targetDiscriminationDataAll(1,2,:), [3,2,1]);
    pCorrect_25percent = permute(targetDiscriminationDataAll(1,3,:), [3,2,1]);
    pCorrect_75percent = permute(targetDiscriminationDataAll(1,4,:), [3,2,1]);
